...
<body style="background-image: url(image/homebackgrndimg1.png);">
	...
	<div class="categolis">
        <table>
            <tr>
                <th>
                    <a href="All/electronic.php" style="text-decoration: none;color: #fff;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Electronic</a>
                </th>
                ...
                <th><a href="All/vehicle.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Vehicle</a></th>
                ...
                <th><a href="All/smartphone.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Mobiles</a></th>
                <th><a href="All/clothes.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Toilatry</a></th>
                ...
                <th><a href="All/book.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Books</a></th>

...
<body>
	<?php include_once "../inc/mainheader.inc.php"; ?>
	<div class="categolis">
		<table>
			<tr>
				<th>
	...
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysqli_query($conn, "SELECT * FROM products WHERE available >='1' AND item ='sweet'  ORDER BY id DESC LIMIT 10") or die(mysqli_error($conn));
